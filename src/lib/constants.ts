export const DISCORD_SERVER = "https://discord.gg/mUZGnSQzsV";
...
export const GITHUB = "https://github.com/tanuthedev/tandetta";
export const PROXY_PREFIX = "https://tandetta.tanu.lol/proxy";
